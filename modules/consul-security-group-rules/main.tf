...
resource "aws_security_group_rule" "allow_server_rpc_inbound_self" {
  type        = "ingress"
  from_port   = "${var.server_rpc_port}"
  to_port     = "${var.server_rpc_port}"
  protocol    = "tcp"
...
resource "aws_security_group_rule" "allow_cli_rpc_inbound_self" {
  type        = "ingress"
  from_port   = "${var.cli_rpc_port}"
  to_port     = "${var.cli_rpc_port}"
  protocol    = "tcp"
...
resource "aws_security_group_rule" "allow_serf_wan_tcp_inbound_self" {
  type        = "ingress"
  from_port   = "${var.serf_wan_port}"
  to_port     = "${var.serf_wan_port}"
  protocol    = "tcp"
...
resource "aws_security_group_rule" "allow_serf_wan_udp_inbound_self" {
  type        = "ingress"
  from_port   = "${var.serf_wan_port}"
  to_port     = "${var.serf_wan_port}"
  protocol    = "udp"
